...
async function clearAllData() {
  await prisma.$transaction(async (tx) => {
    ...
    await tx.auditPlanChecklistAssignment.deleteMany()
    await tx.auditPlanAuditor.deleteMany()
    await tx.auditPlanAuditee.deleteMany()
    await tx.auditPlanEntry.deleteMany()
    await tx.auditChecklistRevisionItem.deleteMany()
    await tx.auditChecklistRevision.deleteMany()
    await tx.auditChecklistItem.deleteMany()
    await tx.auditChecklist.deleteMany()
    await tx.auditSubCategoryType.deleteMany()
    await tx.auditCategoryType.deleteMany()
