...
/**
 * Gelen Denetimler — Bon Air'e dış kuruluşlar/otoriteler/müşteriler tarafından yapılan
 * denetimler. Mevcut Audit Plan motorunun (AuditPlanEntry + checklist/session/finding/CPA/
 * document/history) auditType="INCOMING" ile aynen kullanılan hali. Ayrı bir audit engine YOK,
 * bkz. components/compliance/audit-plan-client.tsx.
 * Yetki kaynağı /compliance/audit-plan ile BİREBİR AYNI (compliance_monitoring izni).
 */
export default async function IncomingAuditsPage() {
  ...
  return <AuditPlanClient auditType="INCOMING" />
}
