  ...
  try {
    const outcome = await prisma.$transaction(
      async (tx) => {
        ...
        const cnt = await tx.departmentForm.count({
        ...
        const successor = await tx.departmentForm.findFirst({
      ...
      },
      {
        ...
        // resulting in an unexpected revision becoming current.
    ...
    console.error("archive-current department-form:", e)
