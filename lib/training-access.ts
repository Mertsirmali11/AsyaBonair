...
/** Eğitim Takip erişimi/yönetimi — Compliance Monitoring departmanı ile aynı kapıyı kullanır. */
export async function assertCanManageTraining(): Promise<
...
export async function canManageTrainingForSession(
